function [] = predictor(weekday,weather,time,actions,temperature)
...
probability_caught = sum(strcmp(train_data.Caught,'Yes')) / total_number;
probability_not_caught = sum(strcmp(train_data.Caught,'No')) / total_number;
...
probability_not_caught_weekday_yes = sum((strcmp(train_data.Caught,'No') + strcmp(train_data.Weekday,'Yes')) == 2)/total_number_not_caught;
probability_not_caught_weekday_no = sum((strcmp(train_data.Caught,'No') + strcmp(train_data.Weekday,'No')) == 2)/total_number_not_caught;

probability_caught_weekday_yes = sum((strcmp(train_data.Caught,'Yes') + strcmp(train_data.Weekday,'Yes')) == 2)/total_number_caught;
probability_caught_weekday_no = sum((strcmp(train_data.Caught,'Yes') + strcmp(train_data.Weekday,'No')) == 2)/total_number_caught;


% Calculate posterior probability about feature weather
probability_not_caught_weather_rain = sum((strcmp(train_data.Caught,'No') + strcmp(train_data.Weather,'Rain')) == 2)/total_number_not_caught;
probability_not_caught_weather_sunny = sum((strcmp(train_data.Caught,'No') + strcmp(train_data.Weather,'Sunny')) == 2)/total_number_not_caught;

probability_caught_weather_rain = sum((strcmp(train_data.Caught,'Yes') + strcmp(train_data.Weather,'Rain')) == 2)/total_number_caught;
probability_caught_weather_sunny = sum((strcmp(train_data.Caught,'Yes') + strcmp(train_data.Weather,'Sunny')) == 2)/total_number_caught;


% Calcualte posterior probability about feature Time
probability_not_caught_time_morning = sum((strcmp(train_data.Caught,'No') + strcmp(train_data.Time,'Morning')) == 2)/total_number_not_caught;
probability_not_caught_time_afternoon = sum((strcmp(train_data.Caught,'No') + strcmp(train_data.Time,'Afternoon')) == 2)/total_number_not_caught;
probability_not_caught_time_midnight = sum((strcmp(train_data.Caught,'No') + strcmp(train_data.Time,'Midnight')) == 2)/total_number_not_caught;

probability_caught_time_morning = sum((strcmp(train_data.Caught,'Yes') + strcmp(train_data.Time,'Morning')) == 2)/total_number_caught;
probability_caught_time_afternoon = sum((strcmp(train_data.Caught,'Yes') + strcmp(train_data.Time,'Afternoon')) == 2)/total_number_caught;
probability_caught_time_midnight = sum((strcmp(train_data.Caught,'Yes') + strcmp(train_data.Time,'Midnight')) == 2)/total_number_caught;


% Calcaulte posterior probability about feature Actions
probability_not_caught_actions_stop = sum((strcmp(train_data.Caught,'No') + strcmp(train_data.Actions,'Stop Sign Violation')) == 2)/total_number_not_caught;
probability_not_caught_actions_speeding = sum((strcmp(train_data.Caught,'No') + strcmp(train_data.Actions,'Speeding')) == 2)/total_number_not_caught;

probability_caught_actions_stop = sum((strcmp(train_data.Caught,'Yes') + strcmp(train_data.Actions,'Stop Sign Violation')) == 2)/total_number_caught;
probability_caught_actions_speeding = sum((strcmp(train_data.Caught,'Yes') + strcmp(train_data.Actions,'Speeding')) == 2)/total_number_caught;


% Calcaculate posterior probability about feature Temperature
probability_not_caught_temperature_low = sum((strcmp(train_data.Caught,'No') + strcmp(train_data.Temperature,'Low')) == 2)/total_number_not_caught;
probability_not_caught_temperature_high = sum((strcmp(train_data.Caught,'No') + strcmp(train_data.Temperature,'High')) == 2)/total_number_not_caught;

probability_caught_temperature_low = sum((strcmp(train_data.Caught,'Yes') + strcmp(train_data.Temperature,'Low')) == 2)/total_number_caught;
probability_caught_temperature_high = sum((strcmp(train_data.Caught,'Yes') + strcmp(train_data.Temperature,'High')) == 2)/total_number_caught;
